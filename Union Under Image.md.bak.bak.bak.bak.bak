...
---
> [!prop]
> The [[Union]] behaves nicely under the [[Image]]:
...
> [[therefore]] $f\left(\bigcup A_\lambda\right)$ [[subset]] $\bigcup f(A_\lambda)$
...
> [[therefore]] $\bigcup f(A_\lambda)$ [[subset]] $f\left(\bigcup A_\lambda\right)$
