...
---
```ad-thm
Let $f:A\rightarrow X$ [[Notation/cartesian product|cartesian product]] $Y$ bee given by the [[Rule of Assignment]]:
$$$f(a) = (f_1(a), f_2(a))$$
...
Suppose $f$ is [[Continuous]], and let $V_1 \times V_2$ be [[Open Set]] in $X\times Y$. Then, 
```
